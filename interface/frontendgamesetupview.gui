guiTypes = {
	...
	containerWindowType = {
		...
		# iconType = {
		# 	name = "unfinished_cover"
		# 	spriteType = "GFX_unfinished_cover"
		# 	position = { x = 0 y = 0 }
		# 	alwaystransparent = yes
		# }
	...
	containerWindowType = {
		...
		# iconType = {
		# 	name = "unfinished_cover_2"
		# 	spriteType = "GFX_unfinished_cover"
		# 	position = { x = 173 y = 53 }
		# 	alwaystransparent = yes
		# }
		# iconType = {
		# 	name = "unfinished_cover_3"
		# 	spriteType = "GFX_unfinished_cover"
		# 	position = { x = 433 y = 53 }
		# 	alwaystransparent = yes
		# }
		# iconType = {
		# 	name = "unfinished_cover_4"
		# 	spriteType = "GFX_unfinished_cover"
		# 	position = { x = 693 y = 53 }
		# 	alwaystransparent = yes
		# }
	...
	containerWindowType = {
		...
		# }
		iconType ={
			name ="IRIS_Jiemianmukuang_2"
			spriteType = "GFX_IRIS_Jiemianmukuang_2"
			position = { x= -90 y = 30 }
			alwaystransparent = yes
		}
		background = {
		...
		containerWindowType = {
			...
			background = {
				name = "666"
				quadTextureSprite ="GFX_countries_grid_bg"
			}
			gridboxType = {
				name ="countries_grid"
				position = { x = 0 y = 0 }
				size = { width = 100% height = 100% }
				slotsize = { width = 195 height = 150 }
				add_horizontal = yes
				max_slots = { x = 4 y = 99 }
				format = "UPPER_LEFT"
			}
		...
		iconType ={
			name ="USR_difficulty"
			spriteType = "GFX_IRIS_difficulty_05"
			position = { x= 25 y = 165 }
			scale = 1.1
			pdx_tooltip = "USR_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="BLA_difficulty"
			spriteType = "GFX_IRIS_difficulty_07"
			position = { x= 25 y = 315 }
			pdx_tooltip = "BLA_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="USF_difficulty"
			spriteType = "GFX_IRIS_difficulty_05"
			position = { x= 25 y = 465 }
			scale = 1.1
			pdx_tooltip = "USF_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="ANZ_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 25 y = 615 }
			pdx_tooltip = "ANZ_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="OCE_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 220 y = 165 }
			pdx_tooltip = "OCE_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="NAC_difficulty"
			spriteType = "GFX_IRIS_difficulty_05"
			position = { x= 220 y = 315 }
			pdx_tooltip = "NAC_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="STG_difficulty"
			spriteType = "GFX_IRIS_difficulty_07"
			position = { x= 220 y = 465 }
			pdx_tooltip = "STG_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="TAU_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 220 y = 615 }
			pdx_tooltip = "TAU_DIFFICULTY_TOOLTIP"
		}
		...
		iconType ={
			...
			pdx_tooltip = "SLL_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="UNG_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 420 y = 315 }
			pdx_tooltip = "UNG_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="BOW_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 420 y = 465 }
			pdx_tooltip = "BOW_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="SRS_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
		...
		iconType ={
			...
			pdx_tooltip = "ELN_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="MAG_difficulty"
			spriteType = "GFX_IRIS_difficulty_05"
			position = { x= 610 y = 315 }
			pdx_tooltip = "MAG_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="DOC_difficulty"
			spriteType = "GFX_IRIS_difficulty_07"
			position = { x= 610 y = 465 }
			pdx_tooltip = "DOC_DIFFICULTY_TOOLTIP"
		}
		iconType ={
			name ="SKR_difficulty"
			spriteType = "GFX_IRIS_difficulty_06"
			position = { x= 610 y = 615 }
			pdx_tooltip = "SKR_DIFFICULTY_TOOLTIP"
		}
		...
		iconType ={
			...
			position = { x= -80 y = 148 }
			scale = 0.8
			pdx_tooltip = "RLN_DIFFICULTY_TOOLTIP"
		}
		...
		iconType ={
			...
			position = { x= -80 y = 218 }
			scale = 0.8
			pdx_tooltip = "MDS_DIFFICULTY_TOOLTIP"
		}
		...
		iconType ={
			...
			position = { x= -80 y = 288 }
			scale = 0.8
			pdx_tooltip = "AKL_DIFFICULTY_TOOLTIP"
		}
		...
		iconType ={
			...
			position = { x= -80 y = 358 }
			scale = 0.8
			pdx_tooltip = "IKR_DIFFICULTY_TOOLTIP"
		}
		#iconType ={
		#	name ="IRIS_Weiwangong1"
		#	spriteType = "GFX_IRIS_Soon"
		#	position = { x= 16 y = 355 }
		#	# alwaystransparent = yes
		#	pdx_tooltip = "USF_BOOKMARK_BLOCKER_DELAYED"
		#}
		iconType ={
			name ="IRIS_Weiwangong2"
			spriteType = "GFX_IRIS_Weiwangong"
			position = { x= 410 y = 55 }
			# alwaystransparent = yes
			pdx_tooltip = "SLL_BOOKMARK_BLOCKER_DELAYED"
		}
		iconType ={
			name ="IRIS_Weiwangong3"
			spriteType = "GFX_IRIS_Weiwangong"
			position = { x= 410 y = 505 }
			# alwaystransparent = yes
			pdx_tooltip = "SRS_BOOKMARK_BLOCKER_DELAYED"
		}
		#iconType ={
		#	name ="IRIS_Weiwangong4"
		#	spriteType = "GFX_IRIS_Weiwangong"
		#	position = { x= 598 y = 505 }
		#	# alwaystransparent = yes
		#	pdx_tooltip = "SKR_BOOKMARK_BLOCKER_DELAYED"
		#}

		containerWindowType = {
			name = new_content_SKR
			position = { x = 627 y = 580 }
			iconType = {
				name = "new_content"
				quadTextureSprite = "GFX_country_new"
				position = { x = 0  y = 0 }
				rotation = 0
				scale = 1
				pdx_tooltip = new_content_SKR_tt
			}
		}

		iconType ={
			name ="IRIS_Weiwangong_mini_KIV"
			spriteType = "GFX_IRIS_Weiwangong"
			position = { x= -57 y = 420 }
			# alwaystransparent = yes
			scale=0.25
			pdx_tooltip = "KIV_BOOKMARK_BLOCKER_DELAYED"
		}

		iconType ={
			name ="IRIS_Weiwangong_mini_BRG"
			spriteType = "GFX_IRIS_Weiwangong"
			position = { x= -57 y = 490 }
			# alwaystransparent = yes
			scale=0.25
			pdx_tooltip = "BRG_BOOKMARK_BLOCKER_DELAYED"
		}

		#真理
		# iconType ={
		# 	name ="IRIS_Weiwangong5"
		# 	spriteType = "GFX_IRIS_Weiwangong"
		# 	position = { x= 205 y = 205 }
		# 	alwaystransparent = yes
		# }
		iconType ={
			name ="IRIS_Weiwangong6"
			spriteType = "GFX_IRIS_Weiwangong"
			position = { x= 410 y = 355 }
			# alwaystransparent = yes
			pdx_tooltip = "BOW_BOOKMARK_BLOCKER_DELAYED"
		}
		iconType ={
			name ="IRIS_Jiemianmukuang"
			spriteType = "GFX_IRIS_Jiemianmukuang"
			position = { x= 0 y = 25 }
			alwaystransparent = yes
		}
		iconType ={
			name ="screen_corner1"
			spriteType = "GFX_screen_corner"
			position = { x= 0 y = 633 }
		}
		iconType ={
			name ="screen_corner2"
		...
		iconType ={
			name ="screen_corner4"
			spriteType = "GFX_screen_corner"
			position = { x= 715 y = 633 }
			rotation=1.57
		}
		iconType ={
			name ="IRIS_Tuijianyouwan1"
			spriteType = "GFX_IRIS_Tuijianyouwan"
			position = { x= 102 y = 55 }
			alwaystransparent = yes
		}
		iconType ={
			name ="IRIS_Chongzhizhong1"
			spriteType = "GFX_IRIS_Chongzhizhong"
			position = { x= 295 y = 55 }
			# alwaystransparent = yes
			pdx_tooltip = "OCE_BOOKMARK_BLOCKER_DELAYED"
		}
		#圣葛
		iconType ={
			name ="IRIS_Tuijianyouwan2"
			spriteType = "GFX_IRIS_Tuijianyouwan"
			position = { x= 295 y = 355 }
			#alwaystransparent = yes
			pdx_tooltip = "STG_BOOKMARK_BLOCKER_DELAYED"
		}
		iconType ={
			name ="IRIS_Tuijianyouwan3"
			spriteType = "GFX_IRIS_Tuijianyouwan"
			position = { x= 685 y = 355 }
			alwaystransparent = yes
		}
		#爱丽诺
		iconType ={
			name ="IRIS_Chongzhizhong2"
			spriteType = "GFX_IRIS_Chongzhizhong"
			position = { x= 685 y = 55 }
			# alwaystransparent = yes
			pdx_tooltip = "ELN_BOOKMARK_BLOCKER_DELAYED"
		}
		# iconType ={
		# 	name ="IRIS_Tuijianyouwan5"
		# 	spriteType = "GFX_IRIS_Tuijianyouwan"
		# 	position = { x= 495 y = 205 }
		# 	alwaystransparent = yes
		# }
		#真理
		iconType ={
			name ="IRIS_Tuijianyouwan6"
			spriteType = "GFX_IRIS_Tuijianyouwan"
		...
		#罗西亚
		iconType ={
			name ="IRIS_Chongzhizhong7"
			spriteType = "GFX_IRIS_Chongzhizhong"
			position = { x= 102 y = 205 }
			#alwaystransparent = yes
			pdx_tooltip = "BLA_BOOKMARK_BLOCKER_DELAYED"
		}
		#早樱
		iconType ={
			name ="IRIS_Tuijianyouwan16"
			spriteType = "GFX_IRIS_Tuijianyouwan"
		...
		#大洋
		containerWindowType = {
			name = highlight_major_0
			position = { x = 280 y = 140 }
			iconType = {
				name = "highlight_major_button"
				quadTextureSprite = "GFX_OCF_diplomatic_interface_parliament"
				position = { x = 0  y = 0 }
				rotation = 0
				scale = 1
				pdx_tooltip = highlight_major_0_tt
			}
		}
		...
		#帕夏
		containerWindowType = {
			name = highlight_major_1
			position = { x = -30 y = 370 }
			iconType = {
				name = "highlight_major_button"
				quadTextureSprite = "GFX_MZL_select_country_cheat"
				position = { x = 0  y = 0 }
				rotation = 0
				scale = 0.8
				pdx_tooltip = highlight_major_1_tt
			}
		}
		...
		#默认位置 乌斯拉尔 X差195 Y差150
		# containerWindowType = {
		# 	name = new_content_USR
		# 	position = { x = 37 y = 130 }
		# 	iconType = {
		# 		name = "new_content"
		# 		quadTextureSprite = "GFX_country_new"
		...
		# 		rotation = 0
		# 		scale = 1
		# 		pdx_tooltip = new_content_USR_tt
		# 	}
		# }

		#containerWindowType = {
		#	name = new_content_OCE
		#	position = { x = 232 y = 130 }
		#	iconType = {
		#		name = "new_content"
		#		quadTextureSprite = "GFX_country_new"
		#		position = { x = 0  y = 0 }
		#		rotation = 0
		#		scale = 1
		#		pdx_tooltip = new_content_OCE_tt
		#	}
		#}

		#诗旎
		# containerWindowType = {
		# 	name = new_content_DOC
		# 	position = { x = 622 y = 430 }
		# 	iconType = {
		# 		name = "new_content"
		# 		quadTextureSprite = "GFX_country_new"
		# 		position = { x = 0  y = 0 }
		# 		rotation = 0
		# 		scale = 1
		# 		pdx_tooltip = new_content_DOC_tt
		# 	}
		# }

		#罗西亚
		# containerWindowType = {
		# 	name = new_content_BLA
		# 	position = { x = 37 y = 280 }
		# 	iconType = {
		# 		name = "new_content"
		# 		quadTextureSprite = "GFX_country_new"
		...
		# 		rotation = 0
		# 		scale = 1
		# 		pdx_tooltip = new_content_BLA_tt
		# 	}
		# }

		#圣葛
		# containerWindowType = {
		# 	name = new_content_STG
		# 	position = { x = 232 y = 430 }
		# 	iconType = {
		# 		name = "new_content"
		# 		quadTextureSprite = "GFX_country_new"
		# 		position = { x = 0  y = 0 }
		# 		rotation = 0
		# 		scale = 1
		# 		pdx_tooltip = new_content_STG_tt
		# 	}
		# }

		#安齐奥
		#containerWindowType = {
		#	name = new_content_ANZ
		#	position = { x = 37 y = 580 }
		#	iconType = {
		#		name = "new_content"
		#		quadTextureSprite = "GFX_country_new"
		...
		#		rotation = 0
		#		scale = 1
		#		pdx_tooltip = new_content_ANZ_tt
		#	}
		#}

		#合众国
		#containerWindowType = {
		#	name = new_content_USF
		#	position = { x = 37 y = 430 }
		#	iconType = {
		#		name = "new_content"
		#		quadTextureSprite = "GFX_country_new"
		...
		#		rotation = 0
		#		scale = 1
		#		pdx_tooltip = new_content_USF_tt
		#	}
		#}
		...
		containerWindowType = {
		 	...
		 	iconType = {
				...
				quadTextureSprite = "GFX_country_new"
		 		...
		 		rotation = 0
		 		scale = 0.7
		 		pdx_tooltip = new_content_minor_MDS_tt
		 	}
		}
		...
		# 		rotation = 0
		# 		scale = 0.7
		# 		pdx_tooltip = new_content_minor_3_tt
		# 	}
		#}

		#左侧-4
		# containerWindowType = {
		# 	name = new_content_minor_4
		# 	# position = { x = -58 y = 360 }
		# 	position = { x = -68 y = 360 }
		# 	iconType = {
		# 		name = "new_content"
		...
		# 		rotation = 0
		# 		scale = 0.7
		# 		pdx_tooltip = new_content_minor_4_tt
		# 	}
		# }

		#左侧-6
		# containerWindowType = {
		# 	name = new_content_minor_6
		# 	position = { x = -58 y = 500 }
		# 	iconType = {
		# 		name = "new_content"
		# 		quadTextureSprite = "GFX_country_new"
		...
		# 		rotation = 0
		# 		scale = 0.7
		# 		pdx_tooltip = new_content_minor_6_tt
		# 	}
		# }
